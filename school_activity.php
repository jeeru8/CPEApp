...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">School Activity</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
                                         	...
                                         	<?php
												...
												if ($result->num_rows > 0) {
												    ...
												    while($row = $result->fetch_assoc()) {
												        ...
												        echo '</td>';
												   		echo '<td>';
												        echo  '<a href="delete-school_activity.php?id='.$row['id'].'" class="btn btn-danger">Delete</a>';
												 
												        echo  '<a href="update-school_activity.php?id='.$row['id'].'" class="btn btn-warning">Update</a>';
												        echo '</td>';
												        echo '</tr>';
												    }
												} else {
			...
			<a href="add-school_activity.php" class="btn btn-success btn-lg">ADD</a>
